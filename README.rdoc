...
https://raw.githubusercontent.com/lingua-franca/lingua_franca/master/screencapture.png
...
==== Example 3: Pushing and popping

Sometimes surrounding your translation in HTML will not produce a desired output, in this case you will need to surround your code with the underscore method and pop the actual translation using +_!+.

  %h1=_'page_titles.My_Image'
  =_'images.myimage.alt_text, :t do
    %img{src: 'myimage.png', alt: _!}
...
The underscore method can also be chained if required:

  %h1=_'page_titles.My_Image'
  =_'images.myimage.alt_text, :t do
    =_'images.myimage.title, :t
      %img{src: 'myimage.png', alt: _!, title: _!}
